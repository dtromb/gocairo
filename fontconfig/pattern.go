...
func (fcr FcResult) String() string {
	switch(fcr) {
		case FcResultMatch: return "success"
		case FcResultNoMatch: return "object not found"
		case FcResultTypeMismatch: return "object type mismatch"
		case FcResultNoId: return "object id out of range"
		case FcResultOutOfMemory: return "out of memory"
	}
	return "?"
}
...
func fcTypeForInterface(obj interface{}) FcType {
	...
	switch(val.Type().Kind()) {
		case reflect.Bool: return FcTypeBool
		case reflect.Int:
		case reflect.Int8:
		case reflect.Int16:
		case reflect.Int32:
		...
		case reflect.Uint16:
		case reflect.Uint32:
		case reflect.Uint64: return FcTypeInteger
		case reflect.Float32:
		case reflect.Float64: return FcTypeDouble
	}
	if _, ok := obj.(string); ok { return FcTypeString }
	if _, ok := obj.(cairo.FtFace); ok { return FcTypeFtFace }
	if _, ok := obj.(cairo.Matrix); ok { return FcTypeMatrix }
	if _, ok := obj.(CharSet); ok { return FcTypeCharSet }
	if _, ok := obj.(LangSet); ok { return FcTypeLangSet }
...
func (pt *stdPattern) GetInteger(name string, n int) (int, bool, error) {
	...
	switch(fcr) {
		case FcResultMatch: return int(i), true, nil
		case FcResultNoMatch: return 0, false, nil
		default: return 0, false, errors.New(fcr.String())
	}
}
...
func (pt *stdPattern) GetDouble(name string, n int) (float64, bool,error) {
	...
	switch(fcr) {
		case FcResultMatch: return float64(d), true, nil
		case FcResultNoMatch: return 0, false, nil
		default: return 0, false, errors.New(fcr.String())
	}
}
...
func (pt *stdPattern) GetString(name string, n int) (string, bool, error) {
	...
	switch(fcr) {
		case FcResultMatch: return C.GoString((*C.char)(unsafe.Pointer(s))), true, nil
		case FcResultNoMatch: return "", false, nil
		default: return "", false, errors.New(fcr.String())
	}
}
...
func (pt *stdPattern) GetMatrix(name string, n int) (cairo.Matrix, bool, error) {
	...
	switch(fcr) {
		...
		case FcResultNoMatch: return nil, false, nil
		default: return nil, false, errors.New(fcr.String())
	}
}
...
func (pt *stdPattern) GetBool(name string, n int) (bool, bool, error) {
	...
	switch(fcr) {
		case FcResultMatch: return b > 0, true, nil
		case FcResultNoMatch: return false, false, nil
		default: return false, false, errors.New(fcr.String())
	}
}
